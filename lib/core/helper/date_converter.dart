...
class DateConverter {
  ...
  static String convertStringTimeToDateOnly(String time) {
    return DateFormat('yyyy-MM-dd HH:mm aa').format(DateFormat('yyyy-MM-dd HH:mm').parse(time));
  }
  ...
  static String dateTimeStringToDateTimeTwo(String dateTime) {
    return DateFormat('d MMM,y HH:mm').format(DateFormat('yyyy-MM-dd HH:mm:ss').parse(dateTime));
  }
