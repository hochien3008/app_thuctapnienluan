...
class CategoryBasedCourseView extends GetView<CourseController> {
  const CategoryBasedCourseView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CourseController>(
      builder: (serviceController) {
        if (serviceController.categoryBasedAllCourse != null &&
            serviceController.categoryBasedAllCourse!.isEmpty) {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount:
                        serviceController.categoryBasedAllCourse!.length > 10
                            ? 10
                            : serviceController.categoryBasedAllCourse!.length,
                    itemBuilder: (context, index) {
                      controller.getServiceDiscount(
                          serviceController.categoryBasedAllCourse![index]);
                      Discount discountModel =
                          PriceFormatter.discountCalculation(
                              serviceController.categoryBasedAllCourse![index]);
                      Course course = serviceController.categoryBasedAllCourse!
                          .elementAt(index);
